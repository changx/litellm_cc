...
class PricingLoader:
        ...
        for provider_name, provider_data in pricing_config["providers"].items():
            for model_name, pricing_data in provider_data["models"].items():
                model_cost_data = ModelCostCreate(
                    ...
                    input_cost_per_million_tokens_usd=pricing_data[
                        "input_cost_per_million_tokens_usd"
                    ],
                    output_cost_per_million_tokens_usd=pricing_data[
                        "output_cost_per_million_tokens_usd"
                    ],
                    cache_write_cost_per_million_tokens_usd=pricing_data[
                        "cache_write_cost_per_million_tokens_usd"
                    ],
                    cache_read_cost_per_million_tokens_usd=pricing_data[
    ...
    def get_model_pricing(
        model_name: str, provider: str = None, config_path: str = None
    ) -> Dict[str, float]:
