...
class AccountCreateRequest(BaseModel):
    ...
    budget_duration: BudgetDuration = Field(
        BudgetDuration.TOTAL, description="Budget duration period"
    )
...
class AccountUpdateRequest(BaseModel):
    ...
    budget_duration: Optional[BudgetDuration] = Field(
        None, description="Budget duration period"
    )
...
class ApiKeyCreateRequest(BaseModel):
    ...
    allowed_models: Optional[List[str]] = Field(
        None, description="List of allowed models, None means all models allowed"
    )
...
class ApiKeyUpdateRequest(BaseModel):
    ...
    allowed_models: Optional[List[str]] = Field(
        None, description="List of allowed models"
    )
