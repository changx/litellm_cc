...
class ModelCost(MongoBaseModel):
    ...
    def calculate_cost(
        ...
        output_cost = (output_tokens / 1_000_000) * self.output_cost_per_million_tokens_usd
        cached_cost = (cached_tokens / 1_000_000) * self.cached_read_cost_per_million_tokens_usd
